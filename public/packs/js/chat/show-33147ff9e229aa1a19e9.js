...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/chat/show.js");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./app/javascript/packs/chat/show.js":
/*!*******************************************!*\
  !*** ./app/javascript/packs/chat/show.js ***!
  \*******************************************/
...
/* WEBPACK VAR INJECTION */(function($) {window.addEventListener("DOMContentLoaded", function (utterance) {
  var partner_image = document.getElementById("partner_image").value; //もっとみるで前の50件を表示

  var messageHash = $('#messagesJson').data('messages');
  var startnum = Number(messageHash.length) - 50;
  var num;
  $('.morebtn').click(function () {
    ...
    messageHash.slice(startnum, num + 1).forEach(function () {
      ...
      var text = AutoLink(messageHash[num].content);
      ...
      if (messageHash[num].file_name !== null) {
        var index = messageHash[num].file_name.indexOf('-');
        console.log(messageHash[num].file_name.slice(index + 1));
        text = '<a href="' + messageHash[num].url + '" download="' + messageHash[num].file_name.slice(index + 1) + '">' + messageHash[num].file_name.slice(index + 1) + '</a>';
      }
      ...
      var time_ber = '';
      var time_flag = document.getElementById(messageHash[num].created_at.slice(0, 10));
      ...
      var html = time_ber + '<div class="row message-body text-wrap" style="white-space: pre;">' + '<div class="col-sm-12 message-main-receiver" style=" position:relative;">' + '<a class="userLink" href="/profiles/' + content.dataset.partnerid + '">' + '<img class="icon bd-placeholder-img flex-shrink-0 me-2 mt-2" style="float: left" width="40px" height="40px" src=' + partner_image + '>' + '</a>' + '<div class="receiver my-1 p-1 mt-2" style="max-width: 40%;">' + '<div class="messages container p-1">' + text + '</div>' + '</div>' + '<div class="text-gray small" style="float: left">' + '<p class="time">' + time + '</p>' + '</div>' + '</div>' + '</div>' + '<div class="clear"></div>';

      if (Number(messageHash[num].user_id) === Number(content.dataset.userid)) {
        html = time_ber + '<div class="row message-body text-wrap" style="white-space: pre;">' + ' <div class="col-sm-12 message-main-sender" style=" position:relative;">' + '<div class="sender my-1 p-1 mt-2" style="max-width: 40%;">' + '<div class="messages container p-1">' + text + '</div>' + '</div>' + '<div class="text-gray small sender_time h-100" style="padding-bottom: 5px">' + time + '</div>' + '</div>' + '</div>' + '<div class="clear"></div>';
      }
...
/******/ });
//# sourceMappingURL=show-33147ff9e229aa1a19e9.js.map